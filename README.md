...
- `daily-pipeline` may auto-generate `directions/<direction>/profile/interest-profile.md` and `directions/<direction>/profile/search-profile.json` if either is missing
